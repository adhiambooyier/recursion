public class PaintingHouses {
    /*
    Your job is to paint a row of n houses red, green, or blue
    so as to minimize total cost, where cost(i, color) = cost to pain house i the specified color.
    You may not paint two adjacent houses the same color. Write a program
